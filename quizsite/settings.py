...
SECRET_KEY = 'django-insecure-@i_7)4r3y(bdk32&fdkr+loc3+76-31-&o2wy=7za%t^4&)hh$'
...
# Максимальный размер аудио файла (50MB)
MAX_UPLOAD_SIZE = 52428800

FILE_UPLOAD_MAX_MEMORY_SIZE = MAX_UPLOAD_SIZE

# Блокировка кэширования для предотвращения возврата назад
