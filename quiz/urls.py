...
urlpatterns = [
        ...
        path('unpublish-test/<int:test_id>/', views.unpublish_test, name='unpublish_test'),

        path('edit-test/<int:test_id>/', views.edit_test, name='edit_test'),
        path('copy-test/<int:test_id>/', views.copy_test, name='copy_test'),

        path('edit-test-base/<int:test_id>/', views.edit_test_base, name='edit_test_base'),
